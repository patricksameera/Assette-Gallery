...
{
    public partial class edit_template_designs : AdminBasePage
    {
        ...
        public static string GetTemplates(string sidx, string sord, int page, int rows, bool search, string searchField, string searchString, string searchOperator)
        {
            ...
            try
            {
                //rtnValue = HttpUtility.JavaScriptStringEncode(proxy.GetTemplates(sidx, sord, page, rows, search, searchField, searchString, searchOperator));
                rtnValue = proxy.GetTemplates(sidx, sord, page, rows, search, searchField, searchString, searchOperator);
            }
            catch (Exception ex)
            {
                Log.Error(ex);
        ...
        [System.Web.Services.WebMethod]
        public static string UpdateTemplateDesigns(string Id, string name, string shortDescription, string longDescription, string firmId, string productId, string preRegisterPreView)
        {
            string rtnValue = string.Empty;
            ...
            try
            {
                rtnValue = proxy.UpdateTemplateDesigns(int.Parse(Id), name, shortDescription, longDescription, int.Parse(firmId), int.Parse(productId), preRegisterPreView);
            }
            catch (Exception ex)
            {
                Log.Error(ex);
        ...
        public static string DeleteTemplateDesign(int Id)
        {
            ...
            try
            {
                rtnVal = proxy.DeleteTemplateDesign(Id);
            }
            catch (Exception ex)
            {
                Log.Error(ex);
