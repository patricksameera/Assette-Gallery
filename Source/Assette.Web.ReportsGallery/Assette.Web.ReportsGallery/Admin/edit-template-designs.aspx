<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit-template-designs.aspx.cs"
    Inherits="Assette.Web.ReportsGallery.Admin.edit_template_designs" MasterPageFile="~/Admin/AdminMasterPage.master" %>

<asp:Content ID="content_edittemplates" ContentPlaceHolderID="Content" runat="Server">
    <%/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////%>
    <%--StyleSheet Reference--%>
    <link href="../Styles/Admin/StyleSheet_A_EditTemplateDesigns.css" rel="stylesheet"
        type="text/css" />
    ...
    <%--Script Reference--%>
    <script src="../Scripts/js/Admin/Script_A_EditTemplateDesigns.js" type="text/javascript"></script>
    ...
    <div class="c1">
        ...
        <table id="gridTemplates">
        </table>
        <div id="pagerTemplates">
        </div>
