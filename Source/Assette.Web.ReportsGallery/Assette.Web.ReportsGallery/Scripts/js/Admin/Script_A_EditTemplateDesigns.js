...
$(document).ready(function () {
    ...
    $('#triggerUpload').live("click", function (e) {
        ...
        location.href = "template-design-uploader.aspx";
    });
    ...
    $('#edittemplatedesigns').css('background-color', '#C1D82F');
    ...
    grid.jqGrid({
        ...
        colModel: [
                      ...
                      { name: 'ShortDescription', width: 150, align: 'left', sortable: false, hidden: true, viewable: true, search: true, searchoptions: { sopt: ['eq', 'cn'], size: 25 }, editable: true, edittype: 'textarea', editrules: { edithidden: true, required: true }, editoptions: { rows: '3', cols: '100'} },
                      { name: 'LongDescription', width: 100, align: 'left', sortable: false, hidden: true, viewable: true, search: true, searchoptions: { sopt: ['eq', 'cn'], size: 25 }, editable: true, edittype: 'textarea', editrules: { edithidden: true, required: true }, editoptions: { rows: '3', cols: '100'} },
                      ...
                      { name: 'PreRegisterPreView', width: 50, align: 'left', sortable: false, hidden: false, search: false, editable: true, edittype: 'checkbox', editoptions: { value: "True:False" }, stype: 'select', search: true, searchoptions: { value: "True:True;False:False", sopt: ['eq', 'ne']} },
        ...
        rowNum: 15,
        rowList: [1, 15, 30, 50],
        pager: jQuery('#pagerTemplates'),
        sortname: "Id",
        sortorder: "asc",
        caption: "Assette - Template Design Details",
        cellEdit: false,
        width: 885,
        height: 270,
        gridview: true,
        ...
        ignoreCase: true,
        rownumbers: true,
        editurl: "../Admin/edit-template-designs.aspx/UpdateTemplateDesigns",
        viewrecords: true,
        ...
        datatype: function (parameterData) {
            GetTemplateDesignData(parameterData);
        },
    ...
    //    grid.jqGrid('navGrid', '#pagerTemplates',
    //               {}, // options
    //               {}, // edit options 
    //               {}, // add options
    //               {}, // delete options
    ...
    // edit options/////////////////////////////////////////////////////////////////////////////////////////
               ...
               onclickSubmit: EditTemplateDesignData
           },
    // add options////////////////////////////////////////////////////////////////////////////////////////////  
               {
               // properties
    ...
    // delete options/////////////////////////////////////////////////////////////////////////////////////////
               ...
               // events
               onclickSubmit: DeleteTemplateDesignData
           },
    // search options///////////////////////////////////////////////////////////////////////////////////////// 
               {
               // properties
    ...
    // show template design data row on grid /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    function GetTemplateDesignData(parameterData) {
        //debugger;
        ...
        // get page count
        var pageCount = $("#sp_1_pagerTemplates").text();
        ...
        $.ajax({
            ...
            url: "../Admin/edit-template-designs.aspx/GetTemplates",
            data: JSON.stringify(parameters),
            dataType: "json",
            success: OnGetTemplateDesignDataSuccess,
            error: OnGetTemplateDesignDataError
        });
    }

    function OnGetTemplateDesignDataError(request, status, error) {
        //debugger;
        ...
        // log4net logging
        var errorText = "OnGetTemplateDesignDataError() jQuery Exception: response text= " + request.responseText + ", status= " + status + ", error= " + error;
        ClientSideLogging(errorText);
    }

    function OnGetTemplateDesignDataSuccess(response, textStatus) {
        //debugger;

        if (textStatus == "success") {
            var thegrid = $("#gridTemplates")[0];
    ...
    // edit template design data /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    function EditTemplateDesignData(parameters, postData) {
        //debugger;

        var parameters = new Object();

        parameters.Id = postData.gridTemplates_id;
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "../Admin/edit-template-designs.aspx/UpdateTemplateDesigns",
            data: JSON.stringify(parameters),
            dataType: "json",
            success: OnEditTemplateDesignDataSuccess,
            error: OnEditTemplateDesignDataError
        });
    }

    function OnEditTemplateDesignDataError(request, status, error) {
        //debugger;
        ...
        // log4net logging
        var errorText = "OnEditTemplateDesignDataError() jQuery Exception: response text= " + request.responseText + ", status= " + status + ", error= " + error;
        ClientSideLogging(errorText);
    }

    function OnEditTemplateDesignDataSuccess(response, textStatus) {
        //debugger;
    ...
    function DeleteTemplateDesignData(parameters, postData) {
        //debugger;
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "../Admin/edit-template-designs.aspx/DeleteTemplateDesign",
            data: JSON.stringify(parameters),
            dataType: "json",
            success: OnDeleteTemplateDesignDataSuccess,
            error: OnDeleteTemplateDesignDataError
        });
    }

    function OnDeleteTemplateDesignDataError(request, status, error) {
        //debugger;
        ...
        // log4net logging
        var errorText = "OnDeleteTemplateDesignDataError() jQuery Exception: response text= " + request.responseText + ", status= " + status + ", error= " + error;
        ClientSideLogging(errorText);
    }

    function OnDeleteTemplateDesignDataSuccess(response, textStatus) {
        //debugger;
    ...
    function ajaxFileUpload(id) {
        ...
        $.ajaxFileUpload
         (
             {
                 url: 'TemplateDesignEditHandler.aspx',
                 secureuri: false,
    ...
    function GetProductTypes() {
        ...
        $.ajax({
            type: "POST",
            url: "../Admin/edit-template-designs.aspx/GetProductTypes",
            data: "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
    ...
    function GetFirmTypes() {
        ...
        $.ajax({
            type: "POST",
            url: "../Admin/edit-template-designs.aspx/GetFirmTypes",
            data: "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
    ...
    function downloadFileFormatter(cellvalue, options, rowObject) {
        ...
        return "<a href='../Admin/FileDownloadHandler.aspx?id=" + rowObject[0] + "&type=t'><u>Download</u></a>";
    }
