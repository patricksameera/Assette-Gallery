...
$(document).ready(function () {
    ...
    $('#goBack').live("click", function (e) {
        ...
        location.href = "edit-template-designs.aspx";
    });
    ...
    var uploader = new qq.FileUploader({
        ...
        action: "TemplateDesignUploadHandler.aspx",
...
function GetFirmTypes() {
    ...
    $.ajax({
        type: "POST",
        url: "../Admin/template-design-uploader.aspx/GetFirmTypes",
        data: "",
...
function GetProductTypes() {
    ...
    $.ajax({
        type: "POST",
        url: "../Admin/template-design-uploader.aspx/GetProductTypes",
        data: "",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
