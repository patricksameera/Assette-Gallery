...
// show slider
function ShowSlideShowDialog(objectId, indexId, sliderContent, reportCount, reportIds, galleryContentIds, reportIdTableTypes) {
    //debugger;
    ...
    //$("#dialog-modal").empty().html(completeSliderContent);
    ...
    $('.control').bind('click', function () {
        ...
        pAObjectId = reportIds[currentPosition - 1];

        // get gallery content id
        galleryContentId = galleryContentIds[currentPosition - 1];

        // get gallery content id
        tableType = reportIdTableTypes[currentPosition - 1];
        ...
        setTimeout(function () {
            ...
            // get report object
            GetMyGalleryPAObjectDetails(objectId, indexId, galleryContentId, tableType);
        }, timeDelay);
    });
