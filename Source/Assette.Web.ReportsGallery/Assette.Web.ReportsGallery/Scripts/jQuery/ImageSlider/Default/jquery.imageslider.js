...
jQuery.fn.slideViewerPro = function (settings) {
    ...
    .wrap(jQuery("<div style='width:" + pictWidth + "px; overflow: hidden; position: relative; top: 0; left: 0'>"));
        ...
        container.each(function (i) {
            ...
            jQuery(this).next().after("<a title='View the previous set of pages' href='#' class='left' id='left" + j + "'><span>" + settings.leftButtonInner + "</span><\/a><a title='View the next set of pages' href='#' class='right' id='right" + j + "'><span>" + settings.rightButtonInner + "<\/span><\/a>");

            jQuery(this).find("li").each(function (n) {
                jQuery("div#thumbSlider" + j + " ul").append("<li><a title='Page " + jQuery(this).find("img").attr("alt") + "' href='#'><img width='" + thumbsWidth + "' height='" + thumbsHeight + "' src='" + jQuery(this).find("img").attr("src") + "' /><p class='tmbrdr'>&nbsp;<\/p><\/a><\/li>");
            });
